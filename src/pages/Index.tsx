        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="general-info" style={{maxWidth:'900px', margin:'0 auto 2rem', textAlign:'center'}}>
            <p style={{fontSize:'1rem', lineHeight:1.5}}>
              <span style={{color:'#008C94', fontWeight:700}}>✱</span> {language === 'pt-BR' ? 'Cada turma tem 20 horas no total, com 8 encontros ao vivo de 2h30 (2 aulas por semana, em regra).' : 'Cada turma tem 20 horas no total, com 8 encontros ao vivo de 2h30 (2 aulas por semana, em regra).'}
            </p>
            <p style={{fontSize:'0.9rem', lineHeight:1.5, marginTop:'0.5rem', color:'#3D3D3D'}}>
              <span style={{color:'#008C94', fontWeight:700}}>✱</span> {language === 'pt-BR' ? 'Os horários indicados são no fuso do Brasil (Brasília UTC−3). O aluno é responsável por ajustar ao seu fuso horário.' : 'Os horários indicados são no fuso de Portugal (Lisboa GMT+0).'}
            </p>
            <p style={{fontSize:'0.9rem', lineHeight:1.5, marginTop:'0.5rem', color:'#3D3D3D'}}>
              {language === 'pt-BR' ? 'Os horários padrão (Portugal/Lisboa) são: 2ª e 4ª 18:00–20:30, 2ª e 4ª 21:00–23:30, 3ª e 5ª 18:00–20:30, 3ª e 5ª 21:00–23:30.' : 'Os horários padrão (Portugal/Lisboa) são: 2ª e 4ª 18:00–20:30, 2ª e 4ª 21:00–23:30, 3ª e 5ª 18:00–20:30, 3ª e 5ª 21:00–23:30.'}
            </p>
          </div>
          ...
          <div className="bonus-list">
            ...
            <div className="bonus-item card-raised bonus-community">
              ...
              <div className="bonus-item-content">
                ...
                <p style={{marginTop:'1rem', color:'#FF304C', fontWeight:600, fontSize:'0.95rem'}}>{language === 'pt-BR' ? 'Bônus de lançamento: acesso vitalício à Comunidade Visionários do Marketing para compras realizadas até 31/03/2026. Promoção limitada.' : 'Bónus de lançamento: acesso vitalício à Comunidade Visionários do Marketing para compras realizadas até 31/03/2026. Promoção limitada.'}</p>
                <p style={{marginTop:'0.75rem', fontSize:'0.875rem', color:'#3D3D3D'}}>{language === 'pt-BR' ? 'A Comunidade Visionários do Marketing é o hub oficial para comunicação, materiais e gravações.' : 'A Comunidade Visionários do Marketing é o hub oficial para comunicação, materiais e gravações.'}</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="faq-cta" style={{backgroundColor:'#FCF9F2', padding:'4rem 1rem'}}>
        <div className="container max-w-6xl mx-auto" style={{display:'flex', flexDirection:'column', gap:'2.5rem'}}>
          <div className="faq" style={{display:'flex', flexDirection:'column', gap:'1rem'}}>
            ...
            <details><summary>As turmas têm vagas limitadas?</summary><div>{language === 'pt-BR' ? 'Sim! Cada turma é formada por, no máximo, 12 participantes, para que você tenha atenção individual, tempo para praticar e ainda troque experiências com outros profissionais, ampliando seu networking de forma estratégica.' : 'Sim! Cada turma é formada por, no máximo, 12 participantes, para que tenhas a atenção individual necessária, tempo para praticar e ainda troques experiências com outros profissionais, ampliando teu networking de forma estratégica.'} {language === 'pt-BR' ? 'As turmas fecham quando atingem 100% das vagas. Ao lotar, a inscrição é bloqueada e entra em modo de Lista de Espera, para casos de desistência.' : 'As turmas fecham quando atingem 100% das vagas. Ao lotar, a inscrição é bloqueada e entra em modo de Lista de Espera, para casos de desistência.'}</div></details>
            <details><summary>Posso abrir vagas extra após a turma lotar?</summary><div>{language === 'pt-BR' ? 'Poderemos abrir até +2 vagas extras em casos específicos (capacidade de suporte e confirmação do professor). Não é garantido. A chamada da lista de espera respeita a ordem de entrada. Contatamos um a um e seguimos para o próximo caso não haja interesse.' : 'Poderemos abrir até +2 vagas extra em casos específicos (capacidade de suporte e confirmação do professor). Não é garantido. A chamada da lista de espera respeita a ordem de entrada. Contactamos um a um e seguimos para o próximo caso não haja interesse.'}</div></details>
            <details><summary>Como funciona a garantia de reembolso?</summary><div>{language === 'pt-BR' ? 'Reembolso total após a 1ª aula completa, solicitado em até 30 dias após essa 1ª aula. Sem necessidade de justificativa (feedback é opcional). A participação na 1ª aula é verificada via relatório do Google Meet. Em caso de reembolso, o aluno perde o direito ao acesso vitalício à comunidade e o acesso aos guias vivos (mesmo dentro da promoção).' : 'Reembolso total após a 1ª aula completa, solicitado em até 30 dias após essa 1ª aula. Sem necessidade de justificativa (feedback é opcional). A participação na 1ª aula é verificada via relatório do Google Meet. Em caso de reembolso, o aluno perde o direito ao acesso vitalício à comunidade e o acesso aos guias vivos (mesmo dentro da promoção).'}</div></details>
            <details><summary>Há taxas de processamento no checkout?</summary><div>{language === 'pt-BR' ? 'No checkout poderá ser acrescida uma taxa de processamento do Stripe: 1,5% + €0,25 (cartões padrão do Espaço Econômico Europeu) ou 1,19% (PIX — Brasil). Em caso de reembolso, essas taxas não são devolvidas (serão abatidas do valor reembolsado). O valor final exibido no checkout é o que prevalece.' : 'No checkout poderá ser acrescida uma taxa de processamento do Stripe: 1,5% + €0,25 (cartões padrão do Espaço Económico Europeu) ou 1,19% (PIX — Brasil). Em caso de reembolso, estas taxas não são devolvidas (serão abatidas do valor reembolsado). O valor final exibido no checkout é o que prevalece.'}</div></details>
            <details><summary>Como funciona o acesso às gravações?</summary><div>{language === 'pt-BR' ? 'As gravações das aulas ficam disponíveis por 30 dias na comunidade. O aluno pode fazer download nesse período e guardar localmente. O material não pode ser divulgado sem consentimento da Atomica e o uso para fins comerciais é proibido. Após o download, a responsabilidade de armazenamento e acesso passa a ser do aluno.' : 'As gravações das aulas ficam disponíveis por 30 dias na comunidade. O aluno pode fazer download nesse período e guardar localmente. O material não pode ser divulgado sem consentimento da Atomica e o uso para fins comerciais é proibido. Após o download, a responsabilidade de armazenamento e acesso passa a ser do aluno.'}</div></details>
            <details><summary>Datas e horários podem mudar?</summary><div>{language === 'pt-BR' ? 'Datas, horários e/ou professor(a) podem sofrer ajustes por razões operacionais. Se acontecer, avisamos pelos canais oficiais (e-mail e comunidade). A turma acontece, em regra, dentro de uma janela de ~30 dias. O calendário completo (datas e horários dos 8 encontros) fica claro para o aluno desde o início e é confirmado por e-mail após a compra.' : 'Datas, horários e/ou professor(a) podem sofrer ajustes por razões operacionais. Se acontecer, avisamos pelos canais oficiais (email e comunidade). A turma decorre, em regra, dentro de uma janela de ~30 dias. O calendário completo (datas e horários dos 8 encontros) fica claro para o aluno desde o início e é confirmado por email após a compra.'}</div></details>
            <details><summary>O que acontece se uma aula precisar de ser realocada?</summary><div>{language === 'pt-BR' ? 'Se precisarmos realocar uma aula, avisamos com mínimo de 1 semana de antecedência pelos canais oficiais (e-mail + comunidade). Exceção: cenários extremos de limitação operacional por parte da Atomica (ex.: indisponibilidade inevitável do professor). Nesses casos, avisamos assim que possível e oferecemos o melhor rearranjo viável.' : 'Se precisarmos realocar uma aula, avisamos com mínimo de 1 semana de antecedência pelos canais oficiais (email + comunidade). Exceção: cenários extremos de limitação operacional por parte da Atomica (ex.: indisponibilidade inevitável do professor). Nesses casos, avisamos assim que possível e oferecemos o melhor rearranjo viável.'}</div></details>
            <details><summary>Como funciona o suporte e onde tiro dúvidas?</summary><div>{language === 'pt-BR' ? 'Dúvidas devem ser enviadas pela comunidade. Tentamos responder em até 72h (compromisso de esforço, não garantia). Existem office hours mensais na comunidade para dúvidas e orientação geral. A Mentoria e a comunidade não oferecem suporte 1:1 sob demanda, nem execução \'done-for-you\'.' : 'Dúvidas devem ser enviadas pela comunidade. Tentamos responder em até 72h (compromisso de esforço, não garantia). Existem office hours mensais na comunidade para dúvidas e orientação geral. A Mentoria e a comunidade não oferecem suporte 1:1 sob demanda, nem execução \'done-for-you\'.'}</div></details>
            <details><summary>Quais são os pré-requisitos para participar?</summary><div>{language === 'pt-BR' ? 'Pré-requisitos: Conta Google, computador compatível com ferramentas web, e disponibilidade para criar contas gratuitas nas ferramentas usadas. Para concluir o projeto, recomendamos pelo menos 8 horas de prática fora das aulas (pode variar conforme experiência e nível de perfeccionismo).' : 'Pré-requisitos: Conta Google, computador compatível com ferramentas web, e disponibilidade para criar contas gratuitas nas ferramentas usadas. Para concluir o projeto, recomendamos pelo menos 8 horas de prática fora das aulas (pode variar conforme experiência e nível de perfeccionismo).'}</div></details>
            <details><summary>As ferramentas de terceiros podem mudar?</summary><div>{language === 'pt-BR' ? 'Ferramentas de terceiros podem mudar preços, planos, funcionalidades ou disponibilidade. Ensinamos conceitos e alternativas sempre que possível.' : 'Ferramentas de terceiros podem mudar preços, planos, funcionalidades ou disponibilidade. Ensinamos conceitos e alternativas sempre que possível.'}</div></details>
            <details><summary>Posso fazer troca de turma ou substituir participante?</summary><div>{language === 'pt-BR' ? 'Para troca de turma, substituição de participante e questões operacionais (pagamento/acesso), contatar: suporte@atomica.group.' : 'Para troca de turma, substituição de participante e questões operacionais (pagamento/acesso), contactar: suporte@atomica.group.'}</div></details>
            <details><summary>Posso usar os materiais para fins comerciais?</summary><div>{language === 'pt-BR' ? 'Os materiais (slides, gravações e templates) são para uso pessoal do aluno. Não é permitido redistribuir, revender ou publicar.' : 'Os materiais (slides, gravações e templates) são para uso pessoal do aluno. Não é permitido redistribuir, revender ou publicar.'}</div></details>
            <details><summary>Como funciona o Pacote de 3 turmas?</summary><div>{language === 'pt-BR' ? 'O Pacote de 3 turmas deve ser usado em até 6 meses a partir da data da compra. Inclui 60h de mentoria e todos os bónus. É possível se inscrever em 2 turmas separadamente. Nesse caso não há desconto: o valor é o dobro (uma inscrição por turma).' : 'O Pacote de 3 turmas deve ser utilizado em até 6 meses a partir da data da compra. Inclui 60h de mentoria e todos os bónus. É possível inscrever-se em 2 turmas separadamente. Neste caso não há desconto: o valor é o dobro (uma inscrição por turma).'}</div></details>
          </div>
