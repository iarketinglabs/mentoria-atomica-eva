        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="cards-container pillar-cards" style={{ gap: "0.5rem" }}>
            ...
            <div className="card card-raised" style={{ padding: "2rem", flex: "1", maxWidth: "400px" }}>
              ...
              <p>
                {language === "pt-BR"
                  ? "Crie sistemas, mesmo sem qualquer experiência técnica, elevando a sua produtividade a outro patamar."
                  : "Cria sistemas, mesmo sem qualquer experiência técnica, elevando a tua produtividade a outro patamar."}
              </p>
              <ul style={{ marginTop: "1rem", marginBottom: "1rem", paddingLeft: "0", listStyle: "none" }}>
                <li style={{ marginBottom: "0.5rem", color: "#3D3D3D", lineHeight: "1.4" }}>
                  ✱{" "}
